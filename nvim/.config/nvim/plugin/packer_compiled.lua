...
_G.packer_plugins = {
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/home/mathieu/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/home/mathieu/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["nvim-treesitter-cpp-tools"] = {
    loaded = true,
    path = "/home/mathieu/.local/share/nvim/site/pack/packer/start/nvim-treesitter-cpp-tools",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/mathieu/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/mathieu/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
